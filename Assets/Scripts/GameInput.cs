...
public class GameInput : MonoBehaviour {
    private const string PLAYER_PREFES_BINDINGS = "InputBindings";
    ...
    private void Awake() {
        ...
        if (PlayerPrefs.HasKey(PLAYER_PREFES_BINDINGS)) {
            playerInputActions.LoadBindingOverridesFromJson(PlayerPrefs.GetString(PLAYER_PREFES_BINDINGS));
        }
